...
def send_message(chat_id, message):
    try:
        ...
        url = f"https://api.telegram.org/bot{key_api}/sendMessage"
...
def find_daft():
    ...
    with open("sented_daft.txt", "r") as date:
    ...
    for result in search_result:
        if result in all_send:
            ...
            with open("sented_daft.txt", "a") as date:
                date.write(f"{result}\n")
...
# https://api.telegram.org/bot{key_api}/getUpdates